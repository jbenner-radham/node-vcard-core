...
export type OrgDirectoryPropertyConfig = [value: string, parameters?: OrgDirectoryParameters];

export type OrgDirectoryPropertyLike = OrgDirectoryProperty | OrgDirectoryPropertyConfig | string;
