...
export type ContactUriPropertyConfig = [value: string, parameters?: ContactUriParameters];

export type ContactUriPropertyLike = ContactUriProperty | ContactUriPropertyConfig | string;
...
export default class ContactUriProperty extends Property {
    ...
    toString() {
        return foldLine(`CONTACT-URI${this.getParametersString()}:${this.valueOf()}`);
    }
